...
function loadSettings() {
  ...
  if (localStorage.getItem('piece_style_white')!==null) {
    ...
    if (THREE.ImageUtils.loadTexture(white_piece_tex_name)===null)
    {
      styleName = 'simple';
  ...
  if (localStorage.getItem('piece_style_black')!==null) {
    ...
    if (THREE.ImageUtils.loadTexture(black_piece_tex_name)===null)
    {
      styleName = 'simple';
  ...
  if (localStorage.getItem('board_style_white')!==null) {
    ...
    if (THREE.ImageUtils.loadTexture(white_square_tex_name)===null)
    {
      styleName = 'simple';
  ...
  if (localStorage.getItem('board_style_back')!==null) {
    ...
    if (THREE.ImageUtils.loadTexture(black_square_tex_name)===null)
    {
      styleName = 'simple';
